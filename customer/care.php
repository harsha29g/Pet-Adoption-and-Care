<html>
    ...
    <table>
        ...
        <tr>
            <h2>Give your pets 24/7 access to fresh drinking water.</h2>
            <p>
        ...
        <tr>
            <h2>Providing a safe, cozy shelter.</h2>
            <p>
        ...
        <tr>
            <h2>Training and Socializing</h2>
            <p>
        ...
        <tr>
            <h2>Doctor visits and healthy habits.</h2>
            <p>
